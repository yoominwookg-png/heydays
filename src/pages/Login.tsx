...
export default function Login() {
  ...
  const { loginWithId, loginWithGoogle, loginWithKakao } = useAuth();
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-[#FEE500] hover:bg-[#FDE000] text-[#191919] font-bold py-4 rounded-2xl border-b-4 border-[#E6CF00] transition-all flex items-center justify-center gap-3 active:border-b-0 active:translate-y-1"
              >
                <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 3C7.305 3 3.5 5.925 3.5 9.534c0 2.215 1.439 4.167 3.616 5.314l-.915 3.356c-.052.193.176.353.332.25l4.02-2.65c.31.028.625.043.947.043 4.695 0 8.5-2.925 8.5-6.534S16.695 3 12 3z"/>
                </svg>
                카카오톡으로 시작하기
              </button>
            </div>
